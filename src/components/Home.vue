    ...
    section
      .container
        ...
        .footer
          ...
          input#weigthField(type='text' placeholder='Вес' v-model='chartWeigth')
          .button.button--round.button-primary(
            @click="newWeigth"
          ) Отправить
          .button.button--round.button-primary(
...
export default {
  ...
  methods: {
    filterYear () {
       alert('Данный фильтр в разработке, станет активен к 10 марта 2021 года')
    },
    filterWeek () {
      this.filterChart = 7
      this.drawChart()
    ...
    newWeigth () {
      ...
      if (this.chartWeigth) {
        ...
        const com = {mass :[dayWorld + ' ' + monthWorld, parseFloat(this.chartWeigth)]}
